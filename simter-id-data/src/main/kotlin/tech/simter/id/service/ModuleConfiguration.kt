...
class ModuleConfiguration {
  /**
   * Starter should config yml key `module.authorization.simter-id` to support specific role control,
  ...
  @ConfigurationProperties(prefix = "module.authorization.simter-id")
